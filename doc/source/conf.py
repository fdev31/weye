...
# -*- coding: utf-8 -*-
#
# Nanowork documentation build configuration file, created by
# sphinx-quickstart on Thu Jul 18 20:17:01 2013.
#
...
html_theme_options = { "roottarget": "index" , 'defaultcollapsed': False}
...
latex_documents = [
  ('index', 'Nanowork.tex', 'Nanowork Documentation',
   'Fabien Devaux', 'manual'),
]
...
man_pages = [
    ('index', 'nanowork', 'Nanowork Documentation',
     ['Fabien Devaux'], 1)
]
...
texinfo_documents = [
  ('index', 'Nanowork', 'Nanowork Documentation',
   'Fabien Devaux', 'Nanowork', 'One line description of project.',
   'Miscellaneous'),
]
